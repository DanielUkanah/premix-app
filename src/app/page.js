...
export default function DashboardHome() {
  ...
  const tools = [
    ...
    { title: "Analysis", desc: "View fleet performance and cost trends.", icon: PieChart, href: "/analysis" },
  ];

  return (
    <div className="min-h-screen bg-[#FDFBFD] font-sans">
      {/* Sleek Gradient Header */}
      <div className="bg-gradient-to-r from-[#3A2472] to-[#C4237F] text-white px-4 sm:px-6 py-4 shadow-md w-full">
        <div className="max-w-5xl mx-auto flex justify-between items-center">
          <h1 className="font-semibold text-lg sm:text-[20px] tracking-tight m-0">Premix TrustConcrete — Dashboard</h1>
